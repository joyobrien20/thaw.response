...
shannon <- read_excel("~/GitHub/Masters_publication/shan_simp.xlsx")
...
# Shannon by site
kruskal.test(shannon$Shannon ~ site, data = shannon)# chi-squared = 13.765, df = 2, p-value = 0.001026
kruskal(shannon$Shannon, shannon$site, group=TRUE, p.adj="bonferroni")$groups #using this to get the letter significance codes 
...
plot_richness(dorm1rarefied_reseq, x = "site", measures = c("Shannon"), color = "pre_post_thaw") +
