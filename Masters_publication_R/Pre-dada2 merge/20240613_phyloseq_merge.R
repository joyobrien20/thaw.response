...
filename <- file.choose("seqtab_06024.rds")
reseq_tab <- readRDS(filename)
...
seqtab <- readRDS("~/GitHub/Masters_publication/seqtab_062024.rds")
seqtab <- readRDS("~/GitHub/Masters_publication/seqtab_062024.rds")

readRDS("~/GitHub/Masters_publication/seqtab_062024.rds")
...
# this works; it merges the samples correctly, but the sample data is not carrying over
#*************************************************************
