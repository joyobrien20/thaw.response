...
## Read the data into R MIGHT HAVE TO RENAME THESE FOR RE-SEQ/CREATE COPY
...
# Rarify OTU table of the new object (dorm_noblank) # Check with Jessica on this rarifaction!
