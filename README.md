...
- thaw_response_script_site.R

Technologies used in the project: 
- University of New Hampshire Hubbard Genome Center: 16S amplicon sequencing with Illumina Novaseq
- Ernakovich lab DADA2 pipeline available here: https://github.com/ErnakovichLab/dada2_ernakovichlab 
- R and R studio
- UNH computing cluster (PREMISE)

Contributers (Ernakovich lab members): 
Jessica Ernakovich
